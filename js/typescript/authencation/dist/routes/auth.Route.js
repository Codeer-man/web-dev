...
// email verify route
router.post("/verify-email/:id", auth_middleware_1.authmiddleware, verify_controller_1.verifyEmail);
// forget password
router.post("/forgetPassword", auth_middleware_1.authmiddleware, password_controller_1.forgetPassword);
